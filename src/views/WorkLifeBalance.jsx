      ...
      <div className="bg-white bg-opacity-80 backdrop-blur-md rounded-2xl shadow-lg border border-emerald-100 p-8">
        <div className="text-center py-12">
          <h2 className="text-2xl font-semibold text-gray-700 mb-3">
            Work-life balance tools in development
          </h2>
          <p className="text-gray-600 max-w-lg mx-auto">
            We're creating features to help you maintain a healthy balance between work and personal life,
            including work hour tracking, break reminders, and productivity optimization.
          </p>
        </div>
      </div>
    </motion.div>
