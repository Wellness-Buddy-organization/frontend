 ...
 * @param {string} mood - Mood label
 * @returns {number} Mood value
 */
...
/**
 * MoodTracker component for visualizing mood data
 * 
 * @param {Object} props
 * @param {Array} props.data - Mood data from API
 */
const MoodTracker = ({ data = [] }) => {
  ...
  return (
    <WellnessCard
      title="Mood Tracker"
      tooltip={`Your most frequent mood this week was ${moodInsights.mostFrequentMood} with an average mood score of ${moodInsights.averageMoodValue}. ${
